...
public class ShrubberyBlocks {
    ...
    public static final DeferredHolder<Block, ShrubberyBushBlock> FLOWERING_BERRY_PLANT = BLOCKS.register("flowering_sweet_berry_plant", () -> new ShrubberyBushBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SWEET_BERRY_BUSH)));
